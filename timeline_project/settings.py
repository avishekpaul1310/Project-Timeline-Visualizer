...
INSTALLED_APPS = [
    ...
    'timeline_app.apps.TimelineAppConfig',
    'crispy_forms',
    'crispy_bootstrap4',
]
...
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'timeline_app:dashboard'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'timeline_app.context_processors.notifications_processor',
            ],
        },
    },
]
...
DEFAULT_FROM_EMAIL = 'Timeline App <noreply@timelineapp.example.com>'